...
import { cn } from "@/lib/utils"; // falls du keinen cn-helper hast: ersetze cn(...) durch className-Strings
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex items-center justify-center rounded-2xl bg-black/30 p-1 border border-white/10",
      className
    )}
    {...props}
  />
